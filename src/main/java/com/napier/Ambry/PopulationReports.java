...
/*
 * Filename:    PopulationReports.java
 * Author:      Sam Wilson-Perkins
 * Last Edited: 21/03/2024
 * Purpose:     This class exists for the functions required for epic 8, and for processing population across areas of the world.
 */
...
public class PopulationReports {
    // Epic 8 - Information Accessible by X category.
    // Population of the world
    public static ArrayList<City> WorldPop (){
        //Stores the query to be sent to the database.
        String select = "SELECT population FROM country ORDER BY population DESC";
